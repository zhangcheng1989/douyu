...
@implementation NSData (ZCSDDataCache)

+ (NSString *)cachePath{
    NSString *path = [[[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)lastObject]stringByAppendingPathComponent:@"Caches"]stringByAppendingPathComponent:@"SDDataCache"];
